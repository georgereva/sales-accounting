    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="products">Товары <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
...
<div class="out" align="left">
    ...
    <div class="bottom"> <a href="./addProduct" class="btn btn-success"   role="button"><span style="margin-right: 5px;" class="glyphicon glyphicon-plus"></span>Новий запис</a></div>
